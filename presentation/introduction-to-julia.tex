...
using PackageName, PackageA, PackageB,
    ...
    \begin{frame}{Package environments}
        \begin{itemize}
            \item in package mode: prefix \mintinline{shell}|(@v1.11) pkg>| refers to the environment:
            ...
            \begin{itemize}[<+->]
                ...
                \item[$\Rightarrow$] file \mintinline{julia}|Project.toml| allows others to install that environment as well:\\
                After activation to \mintinline{julia}|] instantiate| to install all packages in exactly the specified versions
