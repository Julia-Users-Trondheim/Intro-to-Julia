...
# ╔═╡ e2e8c23b-71c8-4b6b-b461-0766da779eba
using PlutoTurtles, PlutoUI

# ╔═╡ 1d1fc25a-0497-11f0-15a9-0b9bf431bc04
md"""
# Turtle mode

This is a short excerpt from the Pluto example notebook [featured.plutojl.org/basic/turtles-art.html](https://featured.plutojl.org/basic/turtles-art.html)
and [PlutoTurtles.jl](https://github.com/JuliaPluto/PlutoTurtles.jl)
"""

# ╔═╡ 413726a8-42ec-4bb2-971c-27a2abf95b86
md"""## "_Een Boom_"
Luka van der Plas (2020)"""

# ╔═╡ aa2374b4-863c-4df7-8726-8f2ccdc5fcab
@bind fractal_angle Slider(0:90; default=49)

# ╔═╡ dcb38de4-19f4-45e8-a5eb-43b69d55a284
@bind fractal_tilt Slider(0:90; default=36)

# ╔═╡ 5dfbc47e-26fc-4a1b-84f0-c01ff54d395c
@bind fractal_base Slider(0:0.01:2; default=1)

# ╔═╡ eeff7bb1-2d73-4473-8e80-49e332673584
...
# ╔═╡ c811fa19-06c5-400e-86f4-db36b2494119
...
manifest_format = "2.0"
project_hash = "aaaa2fc4d26fb85b7e495a91e7a09533516ca1fe"
