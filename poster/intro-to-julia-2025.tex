...
\begin{tikzpicture}[remember picture, overlay, shift={(current page.center)}] % starts a tikz picture environment centered at the center of the page
    ...
    \hl{Julia} is an open source programming language with scientific computing as one of its main targets. It allows for \hl{fast prototyping} while also directly producing \hl{fast and high performance} as well as \hl{reproducible code}.
    \\[\baselineskip]
...
Afterwards we will help you get started and to work on \hl{concrete ideas}, and \hl{first small projects} you want to get started with.
};
